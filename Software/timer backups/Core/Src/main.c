...
int player1_score_flag = 0;
int player2_score_flag = 0;
//SPI PINS and variables
const int clockPin = ((uint16_t)0x0008U);
const int latchPin = ((uint16_t)0x0010U);
const int mosiPin = ((uint16_t)0x0020U);
uint8_t segvalue[8] = {0, 0, 0, 0, 0, 0, 0, 0};
uint8_t display_select = 0;
uint8_t hold = 0;
uint8_t accel[20] = "accelerating/r/n";
uint8_t decel[20] = "decelerating\r\n";
uint8_t stopping[20] = "stopping\r\n";
