...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : DIR_IC_Pin */
  GPIO_InitStruct.Pin = DIR_IC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DIR_IC_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : EN_A_Pin EN_B_Pin _OE_Pin */
  GPIO_InitStruct.Pin = EN_A_Pin|EN_B_Pin|_OE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
